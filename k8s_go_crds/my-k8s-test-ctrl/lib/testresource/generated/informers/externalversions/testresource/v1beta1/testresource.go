...
import (
	...
	v1beta1 "satya.com/my-k8s-test-ctrl/lib/testresource/generated/listers/testresource/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SatyaV1beta1().TestResources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SatyaV1beta1().TestResources(namespace).Watch(options)
			},
		},
